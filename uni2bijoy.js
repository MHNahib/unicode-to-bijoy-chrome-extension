let uni2bijoy_string_conversion_map = {
    "।": "|",
    "‘": "Ô",
    "’": "Õ",
    "“": "Ò",
...
let uni2somewherein_string_conversion_map = {
    "।": "|",
    "‘": "Ô",
    "’": "Õ",
    "“": "Ò",
...
let uni2boisakhi_string_conversion_map = {
    "্র্য": "Ûø",
    "র‌্য": "kø",
    "ক্ক": "~",
    "ক্ট": "ƒ",
...
function ConvertToASCII(ConvertTo, line) {
    let conversion_map = uni2bijoy_string_conversion_map;
    if (ConvertTo == "bijoy")
    ...
    console.log("called till now ")
    line = ReArrangeUnicodeText(line);
    for (let unic in conversion_map) {
